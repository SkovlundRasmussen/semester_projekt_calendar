...
<div id="wrapper">
    ...
    <h1>Slet tid</h1>
    <form action="/delete_appointment" method="post"> <%-- Set action --%>

        <div>
            <input type="number" id="appointmentID" name="app_id" value="<c:out value="${appointment.getAppointmentID()}"/>"/>
